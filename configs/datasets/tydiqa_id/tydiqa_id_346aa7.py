...
system_prompt = '''Silakan baca konteks yang diberikan dan jawab pertanyaannya. Jawaban Anda harus dalam bahasa Indonesia dan sesederhana mungkin.\n'''
...
tydiqa_infer_cfg = dict(
    ...
    inferencer=dict(type=GenInferencer, generation_kwargs=dict(do_sample=False), batch_size=2, max_out_len=100))
